# SITO per MCTS: https://ai-boson.github.io/mcts/
import numpy as np
...
class MonteCarloTreeSearchNode():
    def __init__(self, state: Board, player_id, root_player, duration, c_param, 
        ...
        # hyperparameters
        self.duration = duration   # time duration of each turn
    ...
    # The tree policu used here is the one prefered when using the UCB equation
...
######################################################################################################################
# Variante PNS-MCTS -> Paper: 'Combining Monte-Carlo Tree Search with Proof-Number Search'
